...
(deftest chroma-distance
  ...
  (is 3.15 (m/approx (c/delta-E*-CMC 0xececee 0xeceeec)))
  (is 7.36 (m/approx (c/delta-E*-CMC 0xe9e9ee 0xe9eee9)))
  (is 14.85 (m/approx (c/delta-E*-CMC 0xe4e4ee 0xe4eee4)))
  (is 21.33 (m/approx (c/delta-E*-CMC 0xe0e0ee 0xe0eee0))))
...
(deftest chroma-color
  ...
  (is "#e77dea" (c/format-hex (c/desaturate :hotpink)))
  (is "#cd8ca8" (c/format-hex (c/desaturate :hotpink 2.0)))
  (is "#b299a3" (c/format-hex (c/desaturate :hotpink 3.0))) ;; differs a little bit from original, due to rounding
  ...
  (is 57.57 (m/approx (c/get-channel :orangered :LAB 0)))
