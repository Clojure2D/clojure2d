...
(p/set-canvas-pixels! canvas  (p/filter-colors (c/make-reduce-color-filter v/dist-cos random-palette-6) img))
(p/set-canvas-pixels! canvas  (p/filter-colors (c/make-reduce-color-filter v/dist-emd random-palette-6) img))
(p/set-canvas-pixels! canvas  (p/filter-colors (c/make-reduce-color-filter v/dist-canberra random-palette-6) img))
(p/set-canvas-pixels! canvas  (p/filter-colors (c/make-reduce-color-filter v/dist-discrete random-palette-6) img))
